...
//     : m_sentinal(new Node(0, m_sentinal)), m_head(m_sentinal), m_tail(m_sentinal), m_size(0)
// {
...
// template <typename T>
// bool rangeContains(ListIterator<T> a_begin, ListIterator<T> const a_end, int const a_data)
// {
...
//     Hash *hashMap = HashCreate(size, HashFormula, IsEqual);

//     fillHashFromList(hashMap, a_first);

//     getIntersection(hashMap, a_second, a_result);

//     HashDestroy(&hashMap, ItemDestroy);
//     return a_result;
// }
...
// template <typename T>
// int ListIterator<T>::data() const
// {
//     return m_current->getData();
// }

// template <typename T>
// void ListIterator<T>::setData(int a_data)const
// {
